...
public interface AsyncHandler<T> {
    ...
    public static enum ACTION {ABORT,CONTINUE}
    /**
     ...
     * @throws Exception
     */
    ACTION onBodyPartReceived(HttpResponseBodyPart bodyPart) throws Exception;
     ...
     * @throws Exception
     */
    ACTION onStatusReceived(HttpResponseStatus responseStatus) throws Exception;
     ...
     * @throws Exception
     */
    ACTION onHeadersReceived(HttpResponseHeaders headers) throws Exception;
